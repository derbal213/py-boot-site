from src.functions.split_nodes import split_nodes_image_and_links, split_nodes_delimiter
from src.textnode import TextNode, TextType, TextTypeSyntax

def text_to_text_nodes(text:str) -> list[TextNode]:
    base_node: TextNode = TextNode(text, TextType.PLAIN)

    new_nodes: list[TextNode] = split_nodes_delimiter([base_node], TextTypeSyntax.BOLD, TextType.BOLD)
