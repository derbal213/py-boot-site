import unittest
from src.functions.split_nodes import split_nodes_on_delimiter, split_nodes_on_images_and_links
...
class TestSplitNode(unittest.TestCase):
    ...
    def test_bold(self):
        ...
        new_nodes = split_nodes_on_delimiter([node], TextTypeSyntax.BOLD, TextType.BOLD)
        self.assertEqual(len(new_nodes), 3)
    ...
    def test_italic(self):
        ...
        new_nodes = split_nodes_on_delimiter([node], TextTypeSyntax.ITALIC, TextType.ITALIC)
        self.assertEqual(len(new_nodes), 3)
    ...
    def test_convert_to_HTML(self):
        ...
        for i in range(0, len(nodes) - 1):
            new_nodes = split_nodes_on_delimiter([nodes[i]], syntaxes[i], text_types[i])
    ...
    def test_split_img(self):
        ...
        new_nodes = split_nodes_on_images_and_links([node])
